...
public abstract class SpecialEffectsController {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: PG */
    /* renamed from: android.support.v4.app.SpecialEffectsController$3  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    private void enqueue(Operation.State state, Operation.LifecycleImpact lifecycleImpact, FragmentStateManager fragmentStateManager) {
        synchronized (this.mPendingOperations) {
            ...
            fragmentStateManagerOperation.addCompletionListener(new Runnable() { // from class: android.support.v4.app.SpecialEffectsController.1
            ...
            fragmentStateManagerOperation.addCompletionListener(new Runnable() { // from class: android.support.v4.app.SpecialEffectsController.2
                @Override // java.lang.Runnable
                public void run() {
