...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public Fragment() {
        ...
        this.mPostponedDurationRunnable = new Runnable() { // from class: android.support.v4.app.Fragment.1
    ...
    private ActivityResultLauncher prepareCallInternal(final ActivityResultContract activityResultContract, final Function function, final ActivityResultCallback activityResultCallback) {
        ...
        registerOnPreAttachListener(new OnPreAttachedListener() { // from class: android.support.v4.app.Fragment.8
        ...
        return new ActivityResultLauncher() { // from class: android.support.v4.app.Fragment.9
    ...
    void callStartTransitionListener(boolean z) {
        ...
        if (this.mView != null && (viewGroup = this.mContainer) != null && (fragmentManager = this.mFragmentManager) != null) {
            ...
            if (z) {
                this.mHost.getHandler().post(new Runnable() { // from class: android.support.v4.app.Fragment.3
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: android.support.v4.app.Fragment.4
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            this.mLifecycleRegistry.addObserver(new LifecycleEventObserver() { // from class: android.support.v4.app.Fragment.5
    ...
    public final ActivityResultLauncher registerForActivityResult(ActivityResultContract activityResultContract, ActivityResultCallback activityResultCallback) {
        return prepareCallInternal(activityResultContract, new Function() { // from class: android.support.v4.app.Fragment.6
    ...
    public void startPostponedEnterTransition() {
        if (this.mAnimationInfo != null && ensureAnimationInfo().mEnterTransitionPostponed) {
            if (this.mHost == null) {
                ...
                this.mHost.getHandler().postAtFrontOfQueue(new Runnable() { // from class: android.support.v4.app.Fragment.2
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public final ActivityResultLauncher registerForActivityResult(ActivityResultContract activityResultContract, final ActivityResultRegistry activityResultRegistry, ActivityResultCallback activityResultCallback) {
        return prepareCallInternal(activityResultContract, new Function() { // from class: android.support.v4.app.Fragment.7
            @Override // androidx.arch.core.util.Function
            public ActivityResultRegistry apply(Void r1) {
