    ...
    public static void checkHorizontalSimpleDependency(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, ConstraintWidget constraintWidget) {
        ...
        if (constraintWidget.mHorizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (!z && !z2) {
                ...
                int width8 = constraintWidget.getWidth();
                linearSystem.addEquality(constraintWidget.mLeft.mSolverVariable, x);
                linearSystem.addEquality(constraintWidget.mRight.mSolverVariable, x + width8);
                constraintWidget.mHorizontalResolution = 2;
            }
        }
    }
            ...
            if (!z && !z2 && !z3) {
                if (constraintWidget instanceof Guideline) {
                    ...
                    if (guideline.getOrientation() == 0) {
                        ...
                        int i3 = (int) (relativePercent + 0.5f);
                ...
                int height9 = constraintWidget.getHeight();
                linearSystem.addEquality(constraintWidget.mTop.mSolverVariable, y);
                linearSystem.addEquality(constraintWidget.mBottom.mSolverVariable, height9 + y);
                if (constraintWidget.mBaselineDistance > 0 || constraintWidget.getVisibility() == 8) {
                    constraintWidget.mBaseline.mSolverVariable = linearSystem.createObjectVariable(constraintWidget.mBaseline);
        ...
        while (constraintWidget6 != null) {
            ...
            if (constraintWidget6.getVisibility() != 8) {
                ...
                if (constraintWidget6.mHorizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    if (f3 == 0.0f) {
                        width = f7 + ((f - f6) - margin2);
                    } else {
                        width = f7 + ((((constraintWidget6.mHorizontalWeight * f4) / f3) - f6) - margin2);
                    }
                } else {
                    width = f7 + constraintWidget6.getWidth();
                }
                linearSystem.addEquality(constraintWidget6.mRight.mSolverVariable, (int) (0.5f + width));
                if (i == 0) {
                    width += f;
                }
                f2 = width + margin2;
            ...
            constraintWidget6 = (constraintWidget7 == null || constraintWidget7.mLeft.mTarget == null || constraintWidget7.mLeft.mTarget.mOwner == constraintWidget6) ? constraintWidget7 : null;
            if (constraintWidget6 == constraintWidgetContainer) {
        ...
        while (constraintWidget6 != null) {
            ...
            if (constraintWidget6.getVisibility() != 8) {
                ...
                if (constraintWidget6.mVerticalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    if (f3 == 0.0f) {
                        height = f7 + ((f - f6) - margin2);
                    } else {
                        height = f7 + ((((constraintWidget6.mVerticalWeight * f4) / f3) - f6) - margin2);
                    }
                } else {
                    height = f7 + constraintWidget6.getHeight();
                }
                linearSystem.addEquality(constraintWidget6.mBottom.mSolverVariable, (int) (0.5f + height));
                if (i == 0) {
                    height += f;
                }
                f2 = height + margin2;
            ...
            constraintWidget6 = (constraintWidget7 == null || constraintWidget7.mTop.mTarget == null || constraintWidget7.mTop.mTarget.mOwner == constraintWidget6) ? constraintWidget7 : null;
            if (constraintWidget6 == constraintWidgetContainer) {
                constraintWidget6 = null;
            }
        }
