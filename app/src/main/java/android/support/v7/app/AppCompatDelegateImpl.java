...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean applyApplicationSpecificConfig(boolean z) {
        ...
        if (Build.VERSION.SDK_INT < 33) {
            localeListCompat = calculateApplicationLocales(this.mContext);
        } else {
            localeListCompat = null;
        }
        boolean updateAppConfiguration = updateAppConfiguration(mapNightMode, localeListCompat, z);
    ...
    private Configuration createOverrideAppConfiguration(Context context, int i, LocaleListCompat localeListCompat, Configuration configuration) {
        int i2;
        switch (i) {
            case 1:
                i2 = 16;
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FCM_FUNCTIONAL_DEBUGGING_VALUE) != (configuration2.screenLayout & AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FCM_FUNCTIONAL_DEBUGGING_VALUE)) {
                configuration3.screenLayout |= configuration2.screenLayout & AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FCM_FUNCTIONAL_DEBUGGING_VALUE;
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x0036 A[Catch: NameNotFoundException -> 0x003b, TRY_LEAVE, TryCatch #0 {NameNotFoundException -> 0x003b, blocks: (B:9:0x0012, B:17:0x0025, B:19:0x0036, B:13:0x001b), top: B:25:0x0012 }] */
    /*
    ...
    */
        ...
        if (!this.mActivityHandlesConfigFlagsChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= 29) {
                    ...
                    i = 0;
                    activityInfo = packageManager.getActivityInfo(new ComponentName(context, this.mHost.getClass()), i);
    ...
    public Context attachBaseContext2(Context context) {
        ...
        if (sCanApplyOverrideConfiguration && (context instanceof ContextThemeWrapper)) {
            try {
                ContextThemeWrapperCompatApi17Impl.applyOverrideConfiguration((ContextThemeWrapper) context, createOverrideAppConfiguration(context, mapNightMode, calculateApplicationLocales, null));
                return context;
        ...
        if (context instanceof androidx.appcompat.view.ContextThemeWrapper) {
            try {
                ((androidx.appcompat.view.ContextThemeWrapper) context).applyOverrideConfiguration(createOverrideAppConfiguration(context, mapNightMode, calculateApplicationLocales, null));
                return context;
        ...
        Configuration createOverrideAppConfiguration = createOverrideAppConfiguration(context, mapNightMode, calculateApplicationLocales, configuration);
                ...
                if (this.mActionModeView != null) {
                    ...
                    if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                        ...
                        if (shouldAnimateActionModeView()) {
                            ...
                            alpha.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.app.AppCompatDelegateImpl.7
                                @Override // androidx.core.view.ViewPropertyAnimatorListenerAdapter, androidx.core.view.ViewPropertyAnimatorListener
                                public void onAnimationEnd(View view) {
                                    AppCompatDelegateImpl.this.mActionModeView.setAlpha(1.0f);
                                    AppCompatDelegateImpl.this.mFadeAnim.setListener(null);
    ...
    */
    private boolean updateAppConfiguration(int i, LocaleListCompat localeListCompat, boolean z) {
        ...
        boolean z2;
        Configuration createOverrideAppConfiguration = createOverrideAppConfiguration(this.mContext, i, localeListCompat, null);
        ...
        if (((activityHandlesConfigChangesFlags ^ (-1)) & i4) != 0 && z && this.mBaseContextAttached && (sCanReturnDifferentContext || this.mCreated)) {
            ...
            if ((obj instanceof Activity) && !((Activity) obj).isChild()) {
                ...
                if (!z2 || i4 == 0) {
                    ...
                    updateResourcesConfiguration(i3, configurationLocales, (i4 & activityHandlesConfigChangesFlags) == i4, null);
                }
                if (z3) {
                ...
                if (z3 && configurationLocales != null) {
                    setDefaultLocalesForLocaleList(configurationLocales);
                }
                return z3;
            }
        }
