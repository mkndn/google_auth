...
import android.support.v7.recyclerview.R$attr;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    /* compiled from: PG */
    /* renamed from: android.support.v7.widget.RecyclerView$7  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public abstract class LayoutManager {
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int i, Bundle bundle) {
            ...
            this.mRecyclerView.smoothScrollBy(paddingLeft, i3, null, Integer.MIN_VALUE, true);
            return true;
        }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2) {
            ...
            return Math.min((int) (((abs / width) + 1.0f) * 300.0f), (int) CredentialsApi.CREDENTIAL_PICKER_REQUEST_CODE);
        }
    ...
    */
            ...
            if (i != 0) {
                ...
                if (i2 != 0) {
                    ...
                    if (!dispatchNestedPreFling(f, f2)) {
                        ...
                        if (z) {
                            int i9 = canScrollHorizontally ? 1 : 0;
                            if (canScrollVertically) {
                                i9 |= 2;
                            }
                            startNestedScroll(i9, 1);
                            int i10 = this.mMaxFlingVelocity;
                            int max = Math.max(-i10, Math.min(i, i10));
                            int i11 = this.mMaxFlingVelocity;
                            this.mViewFlinger.fling(max, Math.max(-i11, Math.min(i4, i11)));
                            return true;
                        }
                    }
                    return false;
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE : 33;
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutSuppressed && motionEvent.getAction() == 8) {
            ...
            } else if ((motionEvent.getSource() & AccessibilityEventCompat.TYPE_WINDOWS_CHANGED) != 0) {
    ...
    */
            ...
            case 2:
                ...
                if (this.mScrollState == 1) {
                    ...
                    if (dispatchNestedPreScroll(canScrollHorizontally ? releaseHorizontalGlow : 0, canScrollVertically ? releaseVerticalGlow : 0, this.mReusableIntPair, this.mScrollOffset, 0)) {
                        ...
                        int i5 = releaseVerticalGlow - iArr4[1];
                    ...
                    if (scrollByInternal(canScrollHorizontally ? releaseHorizontalGlow : 0, canScrollVertically ? i : 0, motionEvent, 0)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
                    GapWorker gapWorker = this.mGapWorker;
                    if (gapWorker != null && (releaseHorizontalGlow != 0 || i != 0)) {
                        gapWorker.postFromTraversal(this, releaseHorizontalGlow, i);
                        break;
                    }
                }
                break;
    ...
    private float getSplineFlingDistance(int i) {
        ...
        double d = this.mPhysicalCoef * 0.015f;
        double d2 = f;
        double d3 = f;
        Double.isNaN(d3);
        Double.isNaN(d2);
        double exp = Math.exp((d2 / (d3 - 1.0d)) * log);
        Double.isNaN(d);
        return (float) (d * exp);
    }
    ...
    */
    ...
    public class SavedState extends AbsSavedState {
        public static final Parcelable.Creator CREATOR = new Parcelable.ClassLoaderCreator() { // from class: android.support.v7.widget.RecyclerView.SavedState.1
