    ...
    */
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i14 = 0; i14 < i11; i14++) {
            ...
            float decoratedMeasurementInOther2 = this.mOrientationHelper.getDecoratedMeasurementInOther(view) / ((LayoutParams) view.getLayoutParams()).mSpanSize;
        ...
        while (i22 < i11) {
            ...
            if (this.mOrientation != 1) {
                ...
                layoutDecoratedWithMargins(view4, i7, i6, i5, decoratedMeasurementInOther);
