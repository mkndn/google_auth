...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, MessageParser.MAX_ARG_COUNT, 10000000, 100000000, 1000000000};
    static final int[] halfPowersOf10 = {3, 31, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_ARES_CONTENT_ABUSE_REPORT_VALUE, 3162, 31622, 316227, 3162277, 31622776, 316227766, Integer.MAX_VALUE};
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_1P_HW_DEVICE_MANAGEMENT_VALUE, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
