...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        long convert = TimeUnit.NANOSECONDS.convert(1L, chooseUnit);
        StringBuilder sb = new StringBuilder();
        double d = elapsedNanos;
        double d2 = convert;
        Double.isNaN(d);
        Double.isNaN(d2);
        return sb.append(Platform.formatCompact4Digits(d / d2)).append(" ").append(abbreviate(chooseUnit)).toString();
    }
