...
final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, 110, -1, -1}, new int[]{6, 30, 58, 86, 114, -1, -1}, new int[]{6, 34, 62, 90, 118, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, 102, 126, -1}, new int[]{6, 26, 52, 78, 104, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE, -1}, new int[]{6, 30, 56, 82, 108, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_OR_FEATURE_MEASURING_USER_ENGAGEMENT_VALUE, -1}, new int[]{6, 34, 60, 86, 112, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_1P_APP_PRODUCT_DEVELOPMENT_VALUE, -1}, new int[]{6, 30, 58, 86, 114, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_DEVICE_FINGERPRINT_VALUE, -1}, new int[]{6, 34, 62, 90, 118, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FRAUD_SPAM_ABUSE_PREVENTION_VALUE, -1}, new int[]{6, 30, 54, 78, 102, 126, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_HEADLESS_1P_APP_FUNCTIONAL_DEBUGGING_VALUE}, new int[]{6, 24, 50, 76, 102, 128, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_SERVICE_OR_API_MEASURING_USER_ENGAGEMENT_WW_VALUE}, new int[]{6, 28, 54, 80, 106, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_SERVICE_OR_API_PRODUCT_DEVELOPMENT_VALUE, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_SERVICE_ABUSE_PREVENTION_VALUE}, new int[]{6, 32, 58, 84, 110, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_1P_APP_FUNCTIONAL_DEBUGGING_VALUE, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_GBOARD_PRODUCT_IMPROVEMENT_VALUE}, new int[]{6, 26, 54, 82, 110, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_1P_APP_PRODUCT_DEVELOPMENT_VALUE, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_GPP_UNSAFE_APP_DETECTION_VALUE}, new int[]{6, 30, 58, 86, 114, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_DEVICE_FINGERPRINT_VALUE, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FMD_LOCK_VALUE}};
