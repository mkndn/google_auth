...
public final class GenericGF {
    ...
    static {
        ...
        QR_CODE_FIELD_256 = new GenericGF(AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_HEADLESS_DPC_CLOUD_API_REPORT_DEVICE_INFO_VALUE, 256, 0);
        GenericGF genericGF2 = new GenericGF(AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLAY_CONSOLE_PRODUCT_IMPROVEMENT_VALUE, 256, 1);
    ...
    public String toString() {
        String hexString = Integer.toHexString(this.primitive);
        return "GF(0x" + hexString + "," + this.size + ")";
    }
}
