...
public class GoogleCertificates {
    ...
    /* compiled from: PG */
    /* loaded from: classes.dex */
    public abstract class CertData extends ICertData.Stub {
        protected static final int HASH_BYTES = 25;
        private int mHashValue;

        protected CertData(byte[] bArr) {
            Preconditions.checkArgument(bArr.length == 25);
            this.mHashValue = Arrays.hashCode(bArr);
        }

        protected static byte[] extractBytes(String str) {
            try {
    ...
    /* compiled from: PG */
    /* loaded from: classes.dex */
    class FullCertData extends CertData {
        private final byte[] mCertData;

        /* JADX INFO: Access modifiers changed from: package-private */
        public FullCertData(byte[] bArr) {
    ...
    /* compiled from: PG */
    /* loaded from: classes.dex */
    public final class VALID_PUBLIC_SIGNATURES {
        static final CertData[] KEYS = {GoogleCertificates.APP_RELEASE_CERT, GoogleCertificates.APP_DEBUG_CERT};
    }
