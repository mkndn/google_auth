...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private void maybeDrawCompatShadow(Canvas canvas) {
        ...
        if (width >= 0 && height >= 0) {
            ...
            Bitmap createBitmap = Bitmap.createBitmap(((int) width2) + i + i + width, ((int) height2) + i2 + i2 + height, Bitmap.Config.ARGB_8888);
    ...
    protected int compositeElevationOverlayIfNeeded(int i) {
        ...
        return this.drawableState.elevationOverlayProvider.compositeOverlayIfNeeded(i, z);
    }
    ...
    public int getShadowOffsetX() {
        ...
        double sin = Math.sin(Math.toRadians(this.drawableState.shadowCompatRotation));
        Double.isNaN(d);
        return (int) (d * sin);
    }
    ...
    public int getShadowOffsetY() {
        double d = this.drawableState.shadowCompatOffset;
        double cos = Math.cos(Math.toRadians(this.drawableState.shadowCompatRotation));
        Double.isNaN(d);
        return (int) (d * cos);
    }
