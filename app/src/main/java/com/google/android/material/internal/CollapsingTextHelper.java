...
public final class CollapsingTextHelper {
    ...
    public CollapsingTextHelper(View view) {
        this.view = view;
        TextPaint textPaint = new TextPaint((int) AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_SYSTEM_HEALTH_FUNCTIONAL_DEBUGGING_WW_VALUE);
    ...
    private void calculateUsingTextSize(float f, boolean z) {
        ...
        if (isClose(f, 1.0f)) {
            ...
            width = z ? width2 : width2 * f6 > width ? Math.min(width / f6, width2) : width2;
            f2 = f4;
            f3 = f5;
            typeface = typeface2;
        }
