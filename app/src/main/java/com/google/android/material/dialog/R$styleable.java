...
public final class R$styleable {
    ...
    public static final int[] ChipGroup = {R$attr.checkedChip, R$attr.chipSpacing, R.attr.chipSpacingHorizontal, R.attr.chipSpacingVertical, 2130969555, R.attr.singleLine, R.attr.singleSelection};
    ...
    public static final int[] NavigationView = {16842931, 16842964, 16842973, 16843039, R$attr.bottomInsetScrimEnabled, R$attr.dividerInsetEnd, R$attr.dividerInsetStart, R.attr.drawerLayoutCornerSize, R.attr.elevation, 2130969133, R.attr.itemBackground, R.attr.itemHorizontalPadding, R.attr.itemIconPadding, R.attr.itemIconSize, R.attr.itemIconTint, R$attr.itemMaxLines, R.attr.itemRippleColor, R.attr.itemShapeAppearance, R.attr.itemShapeAppearanceOverlay, R.attr.itemShapeFillColor, R.attr.itemShapeInsetBottom, R.attr.itemShapeInsetEnd, R.attr.itemShapeInsetStart, R.attr.itemShapeInsetTop, R.attr.itemTextAppearance, R.attr.itemTextColor, R$attr.itemVerticalPadding, R.attr.menu, R.attr.shapeAppearance, R.attr.shapeAppearanceOverlay, R$attr.subheaderColor, R.attr.subheaderInsetEnd, R.attr.subheaderInsetStart, R$attr.subheaderTextAppearance, R$attr.topInsetScrimEnabled};
