...
public final class ArrayDecoders {
    ...
    static int decodeExtension(int i, byte[] bArr, int i2, int i3, GeneratedMessageLite.ExtendableMessage extendableMessage, GeneratedMessageLite.GeneratedExtension generatedExtension, UnknownFieldSchema unknownFieldSchema, Registers registers) {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    UnknownFieldSetLite unknownFieldSetLite2 = (UnknownFieldSetLite) SchemaUtil.filterUnknownEnumList(i4, intArrayList4, generatedExtension.descriptor.getEnumType(), unknownFieldSetLite != UnknownFieldSetLite.getDefaultInstance() ? unknownFieldSetLite : null, unknownFieldSchema);
                ...
                default:
                    throw new IllegalStateException("Type cannot be packed: " + String.valueOf(generatedExtension.descriptor.getLiteType()));
            }
        }
    ...
    public static int decodeMessageField(Schema schema, byte[] bArr, int i, int i2, Registers registers) {
        ...
        if (i5 >= 0 && i5 <= i2 - i3) {
            ...
            int i6 = i5 + i3;
            schema.mergeFrom(newInstance, bArr, i3, i6, registers);
    ...
    public static int decodeVarint32(int i, byte[] bArr, int i2, Registers registers) {
        int i3 = i & AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_APP_USAGE_PERSONALIZATION_WW_VALUE;
        int i4 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
