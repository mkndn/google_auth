...
class GJLocaleSymbols {
    ...
    private static void addNumerals(TreeMap treeMap, int i, int i2, Integer[] numArr) {
        while (i <= i2) {
    ...
    private static void addSymbols(TreeMap treeMap, String[] strArr, Integer[] numArr) {
    ...
    public static GJLocaleSymbols forLocale(Locale locale) {
        ...
        if (gJLocaleSymbols == null) {
            ...
            GJLocaleSymbols gJLocaleSymbols2 = (GJLocaleSymbols) cCache.putIfAbsent(locale, gJLocaleSymbols);
