...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) {
        ...
        int i6 = obtainAttributes.getInt(i, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_MESSAGES_SUPERSORT_PRODUCT_IMPROVEMENT_VALUE);
        ...
        boolean z = obtainAttributes.getInt(i2, 0) == 1;
