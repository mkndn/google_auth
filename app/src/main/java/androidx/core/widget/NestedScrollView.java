...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild {
            ...
            if (nestedScrollView.isEnabled()) {
                ...
                switch (i) {
                    ...
                    case 16908344:
                        ...
                        int max = Math.max(nestedScrollView.getScrollY() - ((height - paddingBottom2) - nestedScrollView.getPaddingTop()), 0);
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE)) ? false : true;
            ...
            switch (keyEvent.getKeyCode()) {
                ...
                case 20:
                    if (!keyEvent.isAltPressed()) {
                        return arrowScroll(AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE);
                    }
                    return fullScroll(AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE);
                case 62:
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != 0.0f) {
                float verticalScrollFactorCompat = getVerticalScrollFactorCompat();
                int scrollRange = getScrollRange();
                int scrollY = getScrollY();
                int i2 = scrollY - ((int) (axisValue * verticalScrollFactorCompat));
                if (i2 < 0) {
                    if (canOverScroll() && !MotionEventCompat.isFromSource(motionEvent, FragmentTransaction.TRANSIT_FRAGMENT_CLOSE)) {
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_PLATFORM_MARKET_STATISTICS_WW_VALUE;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
    ...
    */
        ...
        switch (actionMasked) {
            ...
            case 2:
                ...
                if (findPointerIndex == -1) {
                    ...
                    int releaseVerticalGlow = i4 - releaseVerticalGlow(i4, motionEvent.getX(findPointerIndex));
                    if (!this.mIsBeingDragged && Math.abs(releaseVerticalGlow) > this.mTouchSlop) {
                        ...
                        if (releaseVerticalGlow > 0) {
                            i = releaseVerticalGlow - this.mTouchSlop;
                            if (this.mIsBeingDragged) {
                                ...
                                boolean z3 = overScrollByCompat(0, i2, 0, getScrollY(), 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(0);
                                int scrollY2 = getScrollY() - scrollY;
                                int[] iArr = this.mScrollConsumed;
                                iArr[1] = 0;
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x0089 A[ADDED_TO_REGION] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public final void smoothScrollBy(int i, int i2) {
        smoothScrollBy(i, i2, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FAMILY_ADMIN_VALUE, false);
    }
    ...
    */
    ...
    private void smoothScrollBy(int i, int i2, int i3, boolean z) {
        ...
        if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250) {
            ...
            int paddingBottom = getPaddingBottom();
            int scrollY = getScrollY();
            this.mScroller.startScroll(getScrollX(), scrollY, 0, Math.max(0, Math.min(scrollY + i2, Math.max(0, ((height + i4) + i5) - ((height2 - paddingTop) - paddingBottom)))) - scrollY, i3);
            runAnimatedScroll(z);
        } else {
            if (!this.mScroller.isFinished()) {
                abortAnimatedScroll();
    ...
    void smoothScrollTo(int i, int i2, boolean z) {
        smoothScrollTo(i, i2, AndroidPrivacyAnnotationsEnums$CollectionUseCase.UC_FAMILY_ADMIN_VALUE, z);
    }
