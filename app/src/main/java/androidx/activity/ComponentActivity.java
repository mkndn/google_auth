...
public class ComponentActivity extends SupportActivity implements LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner {
    ...
    public /* synthetic */ Bundle m6lambda$new$0$androidxactivityComponentActivity() {
    ...
    public /* synthetic */ void m7lambda$new$1$androidxactivityComponentActivity(Context context) {
    ...
    public ComponentActivity() {
        ...
        getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda1
            ...
            public final Bundle saveState() {
                return ComponentActivity.this.m6lambda$new$0$androidxactivityComponentActivity();
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.activity.ComponentActivity$$ExternalSyntheticLambda2
            ...
            public final void onContextAvailable(Context context) {
                ComponentActivity.this.m7lambda$new$1$androidxactivityComponentActivity(context);
            }
        });
    }
